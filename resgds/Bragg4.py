...
# Layout filename
layout_file ='fab_files/Bragg4.gds'
...
###########################################################################
no_periods = 4
cavity = bragg.Bragg(wc, gc, lhigh, poly_cell, radius=rhigh, layer=2)
...
cavity.mirror(xb_strt, yb_strt, w_remove=wc, g_remove=gc)
