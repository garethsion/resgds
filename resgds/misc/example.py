...
rect0 = [(-4, -4), (-4, 4), (4, 4), (4, -4)]
rect1 = [(0, 0), (0, 2), (2, 2)]

# Create the polygon on layer 1.
poly0 = gdspy.Polygon(rect0, 0)
poly1 = gdspy.Polygon(rect1, 0)

# Add the new polygon to the cell.
#poly_cell.add(poly0)
# poly_cell.add(poly1)

grnd = gdspy.fast_boolean(poly0,poly1,'not',precision=1e-9, max_points=1000, layer=0)
poly_cell.add(grnd)
