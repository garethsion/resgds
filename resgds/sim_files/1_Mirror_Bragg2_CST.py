...
# Layout filename
layout_file ='1_Mirror_Bragg2_CST.gds'
...
xb_strt,yb_strt = [coords(3000),coords(sub_y/2)- lext2 - lext3 - 140]
...
#
# xf0Low = xhz1 + highZ.mirror_width() - wlow/2 - whigh/2#xb_strt + no_periods*(lowZ.mirror_width() + highZ.mirror_width())
xf0Low = xb_strt-wlow/2+wc/2#xb_strt + no_periods*(lowZ.mirror_width() + highZ.mirror_width())
yf0Low = yb_strt
...
feedbond = [rs.triangle(xbond+whigh,ybond,xbond,ybond,
	xbond-400,ybond-321.5147,xbond+400,ybond-321.5147)]
...
rstrt = rstrt - 7.185
# xf0Low = xhz1 + highZ.mirror_width() - rmw/2 - 1
xf0Low = xb_strt-rmw/2+wc/2
yf0Lowr = yf0Low
...
feedline_remove += [rs.triangle(xbond+rmw,ybond,xbond,ybond,
	xbond-440,ybond-322,xbond+480,ybond-322)]
...
feedline_remove += [rs.triangle(xbond,ybond,xbond+rmw,ybond,
	xbond+480,ybond+322,xbond-440,ybond+322)]
