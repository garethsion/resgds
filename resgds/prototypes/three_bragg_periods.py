...
# Layout filename
layout_file ='fab_files/three_bragg_periods_xoff='+str(wrhead_yoff)+'_yoff='+str(wrhead_yoff)+'.gds'
...
sub.make(wrhead_xoff,wrhead_yoff)

# Antidot array [layer 1]
layout = LayoutComponents(poly_cell, sub_x, sub_y,layer=1)
dots = layout.make_antidot_array(wrhead_xoff,wrhead_yoff,10,30,0)
...
xb_strt,yb_strt = [coords(sub_x/2,wrhead_xoff),coords(sub_y/2,-lext2 - lext3 - 140+wrhead_yoff)]
