...
rlow = 55 # Radius of low impedance section
rhigh = 55 # Radius of high impedance section
...
rhf2 = rs.make_halfarc(0, wdth2, rms2[1][0] + wdth2/2 - 12.65, y0+l2, orientation='N', npoints=40,layer=3)
