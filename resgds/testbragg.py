...
x1 = x0 + wlow + 2*glow
y1= y0 + l1
mirror.quarterarc_trench(rlow, x1, y1, orient='NW', npoints=20)

x2 = x1
y2 = y1
l2 = 200
mirror.straight_trench(l2,x2,y2,orient='H')

x3 = x2 + l2
y3 = y2
mirror.quarterarc_trench(rlow, x3, y3, orient='NE', npoints=20)
...
x5 = x4 + wlow + 2*glow
y5 = y4
mirror.quarterarc_trench(rlow, x5, y5, orient='SW',npoints=20)

x6 = x5
y6 = y5 - wlow - 2*glow
mirror.straight_trench(l2,x6,y6,orient='H')

x7 = x6 + l2
y7 = y6 + wlow + 2*glow
mirror.quarterarc_trench(rlow, x7, y7, orient='SE',npoints=20)

l4 = l3 - l1
x8 = x7
y8 = y7
mirror.straight_trench(l4,x8,y8,orient='V')

#mirror.halfarc_trench(rlow, x7, y7, orient='E', npoints=40)
