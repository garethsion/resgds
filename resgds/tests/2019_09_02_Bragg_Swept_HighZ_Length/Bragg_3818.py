...
marker += [rs.circ_arc(50, 350, 300, n=50, theta0=0, thetaf=2*np.pi)]
marker += [rs.circ_arc(50, 500, 300, n=50, theta0=0, thetaf=2*np.pi)]
marker += [rs.circ_arc(50, 650, 300, n=50, theta0=0, thetaf=2*np.pi)]
marker += [rs.circ_arc(50, 800, 300, n=50, theta0=0, thetaf=2*np.pi)]
marker += [rs.circ_arc(50, 200, 100, n=50, theta0=0, thetaf=2*np.pi)]
